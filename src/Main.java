...
//Principal:
    ...
    thabo.viewMyPerformance();
    Teacher1.viewClassPerformance(group10A);
    hodSciences.viewDepartmentPerformance(scienceDept);
    principal.viewSchoolPerformance(allDepartments);
